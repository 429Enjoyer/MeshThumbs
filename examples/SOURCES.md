...
| 3DM without mesh cache | `PlanarSurface.3dm` | [McNeel planar Brep](https://github.com/mcneel/rhino-developer-samples/blob/786cf13c4a1ea50444fbf6471b1a8a1507b3114f/rhino.inside/dotnet-netcore/BatchOperation/files/03.3dm), permissive McNeel license |
| IFC2x3 | Duplex Apartment architectural model | [buildingSMART community](https://github.com/buildingsmart-community/Community-Sample-Test-Files/tree/7ddf57a201f88a0c213d5322b02ed15e94a60a40/IFC%202.3.0.1%20(IFC%202x3)/Duplex%20Apartment), CC BY 4.0 |
| IFC4 | `Basin.ifc` | [buildingSMART reference sample](https://github.com/buildingSMART/Sample-Test-Files/blob/80d976a9b193a26a8e928c3e79bff67af1de68a8/IFC%204.0.2.1%20(IFC%204%20ADD2%20TC1)/ISO%20Spec%20-%20ReferenceView_V1.2/basin-tessellation.ifc), CC BY 4.0 |
...
## 3DM without a saved mesh

McNeel's `03.3dm` previously failed because its planar Brep had no cached mesh.
It now renders unchanged as `PlanarSurface.3dm`. The same source collection's
`01.3dm` extrusion was also checked after removing only its render-mesh cache
in a temporary test copy. Native regression fixtures check cap holes, curved
profiles, open extrusions, mitered ends, mirrored transforms, winding and volume.
The uncached curved Brep in `02.3dm` and the SubD sample remain unsupported.

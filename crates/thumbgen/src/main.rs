...
fn main() -> anyhow::Result<()> {
    ...
    if args.len() < 2 {
        bail!("usage: thumbgen <model.obj|fbx|glb|gltf|stl|dae|ply|3ds|3mf|vrm|blend|x3d|off|usd|usda|usdc|usdz|wrl|vrml|step|stp|abc|igs|iges|3dm|ifc|pmx|vox|lwo> <out.png> [size]");
    }
